...
###### Ainda não acertei aqui....eu tinha tentado de outras formas mas sei lá o que houve que perdi algumas coisas que tinha feito...mas de qq jeito não tinha conseguido salvar.
...
TS_Plot_State <- ggplot(data = subset(d2, LEVEL == "UF" & STATE == States_sivep), aes(DATE, CASE, color = TYPE)) + ###testar
  stat_summary(fun.y = sum, geom = "line") +
  scale_x_date(breaks = "year",
               date_labels = "%Y") +
