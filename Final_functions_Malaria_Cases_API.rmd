...
save(teste, file = "/home/rlana/Dados/Age_gender_Noti_weekly.Rdata")
...
Cases_Plot_State <- ggplot(data = subset(Sivep_Strat, LEVEL == "UF"), aes(AGE_CAT, CASES, color = GENDER)) + ###testar
...
MA <- ggplot(aes(y = n, x = AGE_CAT, fill = GENDER), data = Sivep_strat) +
