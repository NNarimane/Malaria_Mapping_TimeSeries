...
```{r setup, include=FALSE}
p03 <- fread("Dados/PopEstimada/pop2003.csv", encoding = 'Latin-1')
#head(p03)

p04 <- fread("Dados/PopEstimada/pop2004.csv", encoding = 'Latin-1')

p05 <- fread("Dados/PopEstimada/pop2005.csv", encoding = 'Latin-1')

p06 <- fread("Dados/PopEstimada/pop2006.csv", encoding = 'Latin-1')

p07 <- fread("Dados/PopEstimada/pop2007.csv", encoding = 'Latin-1')

p08 <- fread("Dados/PopEstimada/pop2008.csv", encoding = 'Latin-1')

p09 <- fread("Dados/PopEstimada/pop2009.csv", encoding = 'Latin-1')

p10 <- fread("Dados/PopEstimada/pop2010.csv", encoding = 'UTF-8') #Feito no Linux

p11<- fread("Dados/PopEstimada/pop2011.csv", encoding = 'Latin-1')

p12 <- fread("Dados/PopEstimada/pop2012.csv", encoding = 'Latin-1')

p13 <- fread("Dados/PopEstimada/pop2013.csv", encoding = 'Latin-1')

p14 <- fread("Dados/PopEstimada/pop2014.csv", encoding = 'Latin-1')

p15 <- fread("Dados/PopEstimada/pop2015.csv", encoding = 'Latin-1')

p16 <- fread("Dados/PopEstimada/pop2016.csv", encoding = 'Latin-1')

p17 <- fread("Dados/PopEstimada/pop2017.csv", encoding = 'Latin-1')

dim(p03)
#5560 municípios em 2003
#5570 municípios em 2017
