...
USAR CUT e cria as categ no LABEL: para não sair o level, tenho que fazer um cut em uma variável numerica e depois geral o label...ver se é isso.

LEMBRAR DE GERAR MEDIANA E DESVIO PADRAO IDADE X SEXO QUANDO GERAR AS TABELAS PAR AOS PLOTS.


```{r}

teste <- df %>% 
   mutate(AGE_CONT = as.double(AGE_CONT)) %>%
  cut(AGE_CONT, breaks = 17, labels = c("0-4", "5-9", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59", "60-64", "65-69", "70-74", "75-79", "80+"), ordered_result = T) #VER COMO USAR DIREITO
