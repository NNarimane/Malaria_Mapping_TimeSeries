...
**CATEGORI**: informs the category to which the locality belongs (neighborhood, site, village, settlement, etc.), according to the table of categories attached.       
...
### Settlement data and developments

- abrir o shape de assentamentos e ver se tem de grandes empreendimentos e suas infos.
- Talvez ver muni que tem mais desmatamento com a var ocupação. Ver a questão do outros. Ver tb muni que tem mais garimpo...já pode indicar atividades ilegais.    
- Talvez tenha algo sobre a abrangência dos grandes empreendimentos.  

- Example for Acre state: figure out about variable means.
```{r}
...
- Looking for local healthcare clinics: http://datasus.saude.gov.br/sistemas-e-aplicativos/cadastros-nacionais/cnes OK

- NASA POWER: Oswaldo tem script para baixar. Dados diários. https://power.larc.nasa.gov/  OK

- Mineração: tem nos dados de LUCC - pegar um exemplo que temos de mapa. Tem aqui tb: http://www.anm.gov.br/assuntos/ao-minerador/sigmine. baixa por estado e tem todos os tipos de processo que chegam para a DNPM. Só tem que limpar... talvez por SUBs selecionar ouro.    

- Extrativismo: não tem pronto, teria que mapear

- Grande empreendimentos como barragens: http://www.snisb.gov.br/portal/snisb/mapas-tematicos-e-relatorios/tema-1-1

- Sobre Usinas, reservatórios: tem o site da Aneel: dá para baixar em shape e kmz: https://sigel.aneel.gov.br/Down/
...
7- The variable about occupation has the category "Others" that has a expressive numbers os registry. How is this category filled in? What kind of ocupation is included in this category?
