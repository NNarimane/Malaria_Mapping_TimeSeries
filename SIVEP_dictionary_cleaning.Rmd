...
- Looking for local healthcare clinics: http://datasus.saude.gov.br/sistemas-e-aplicativos/cadastros-nacionais/cnes 

- CHIRPS ou MSWEP: esses dois são outros dados de clima (mais recente): http://worldclim.org/version2. Ver pasta /home/claudia/Documentos/PosDoc_PROCC/Amazonia_all_LLwgs84, tem dados de tudo quanto há, baixei daqui AMBDATA: http://www.dpi.inpe.br/Ambdata/download.php  

- NASA POWER: Oswaldo tem script para baixar. Dados diários. https://power.larc.nasa.gov/

- dado de evapotranspiração do  Modis https://modis.gsfc.nasa.gov/data/dataprod/mod16.php (dado em grade - 500m).
